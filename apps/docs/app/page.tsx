...
export default function LandingPage() {
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl dark:text-gray-400">
                    Transform your body and mind with Zeus - the ultimate gym companion app that brings the power of <FlipWords className="text-black font-bold" duration={1000} words={words} /> to your workouts.
                  </p>
                </div>
  ...
  <CarouselContent className="">
    <CarouselItem><img src="/image1.png" className="rounded-2xl h-[800px] object-cover w-[800px]" alt="" /></CarouselItem>
    <CarouselItem><img src="/image2.png" className="rounded-2xl h-[800px] object-cover w-[800px]"  alt="" /></CarouselItem>
    <CarouselItem><img src="/image5.jpg" className="rounded-2xl" alt="" /></CarouselItem>
        ...
        <section id="pricing" className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">Choose Your Destiny</h2>
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
                ...
                <p className="text-center text-gray-500 dark:text-gray-400 mb-4">For those beginning their ascent</p>
                <p className="text-4xl font-bold text-center mb-6">$9.99<span className="text-sm font-normal">/month</span></p>
              ...
              <div className="flex flex-col p-6 bg-yellow-500 text-white rounded-lg shadow-lg">
                ...
                <p className="text-center mb-4">For serious fitness enthusiasts</p>
                <p className="text-4xl font-bold text-center mb-6">$19.99<span className="text-sm font-normal">/month</span></p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                ...
                <Button className="mt-auto bg-white text-yellow-500 hover:bg-gray-100">Choose Plan</Button>
              </div>
              <div className="flex flex-col p-6 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-center mb-4">Olympian</h3>
                <p className="text-center text-gray-500 dark:text-gray-400 mb-4">For those seeking godly perfection</p>
                <p className="text-4xl font-bold text-center mb-6">$29.99<span className="text-sm font-normal">/month</span></p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-center">
                    <ChevronRight className="h-5 w-5 text-yellow-500 mr-2" />
        ...
        <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-center mb-12">Praise from Olympus</h2>
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 border-gray-200 p-4 rounded-lg shadow-sm">
                <Image
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  "Zeus has taken my strength to new heights. I couldn't have completed my 12 labors without it!"
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-200 p-4 rounded-lg shadow-sm">
                <Image
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  "The wisdom in Zeus's training plans is unparalleled. It's not just about strength, but strategy too."
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 border-gray-200 p-4 rounded-lg shadow-sm">
                <Image
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  "As the god of physical perfection, I approve. Zeus has helped me maintain my godly physique."
                </p>
              </div>
            </div>
          </div>
