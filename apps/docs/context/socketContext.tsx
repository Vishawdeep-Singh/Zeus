...
import { socketState, userState, connectionErrorState, loadingState } from '@/states/socket';
...
// console.log(session.data?.user)
  useEffect(() => {
    console.log("useEffect triggered with session user ID:", session.data?.user.id);
...
export const useWebSocket = () => {
  const { socket, user, setUser, connectionError, loading } = useContext(WebSocketContext);
